...
const translations = {
  en: {
    ...
    heroLine1: 'Social media took over our minds. AI is about to take over our humanity.',
    heroLine2: 'Trillion-dollar companies are racing to replace our jobs, relationships, and political power.',
    heroLine3: 'This is our last chance to do something different.',
  ...
  es: {
    ...
    heroLine1: 'Las redes sociales se apoderaron de nuestras mentes. La IA está a punto de apoderarse de nuestra humanidad.',
    heroLine2: 'Empresas de billones de dólares compiten por reemplazar nuestros trabajos, relaciones y poder político.',
    heroLine3: 'Esta es nuestra última oportunidad para hacer algo diferente.',
  ...
  zh: {
    ...
    tagline1: '让你的声音被听见',
    tagline2: '趁一切还来得及。',
    heroLine1: '社交媒体控制了我们的思想。人工智能即将控制我们的人性。',
    heroLine2: '万亿美元的公司正在竞相取代我们的工作、关系和政治权力。',
    heroLine3: '这是我们做出改变的最后机会。',
  ...
  ja: {
    ...
    tagline1: 'あなたの声を届けよう',
    tagline2: '今ならまだ間に合う。',
    heroLine1: 'ソーシャルメディアは私たちの心を支配した。AIは私たちの人間性を奪おうとしている。',
    heroLine2: '数兆ドル規模の企業が、私たちの仕事、人間関係、政治的権力を置き換える競争をしている。',
    heroLine3: '今こそ、私たちが行動を起こす最後のチャンスだ。',
  ...
  ko: {
    ...
    heroLine1: '소셜 미디어가 우리의 마음을 지배했습니다. AI가 우리의 인간성을 빼앗으려 합니다.',
    heroLine2: '수조 달러 규모의 기업들이 우리의 일자리, 관계, 정치적 권력을 대체하기 위해 경쟁하고 있습니다.',
    heroLine3: '이것이 우리가 다르게 행동할 마지막 기회입니다.',
  ...
  fr: {
    ...
    heroLine1: "Les réseaux sociaux ont pris le contrôle de nos esprits. L'IA est sur le point de prendre le contrôle de notre humanité.",
    heroLine2: "Des entreprises de mille milliards de dollars sont lancées dans une course pour remplacer nos emplois, nos relations et notre pouvoir politique.",
    heroLine3: "C'est notre dernière chance de faire quelque chose de différent.",
  ...
  hi: {
    ...
    heroLine1: 'सोशल मीडिया ने हमारे दिमागों पर कब्ज़ा कर लिया। AI हमारी मानवता पर कब्ज़ा करने वाला है।',
    heroLine2: 'खरबों डॉलर की कंपनियां हमारी नौकरियों, रिश्तों और राजनीतिक शक्ति को बदलने की होड़ में हैं।',
    heroLine3: 'यह हमारे लिए कुछ अलग करने का आखिरी मौका है।',
  ...
  ar: {
    ...
    heroLine1: 'وسائل التواصل الاجتماعي سيطرت على عقولنا. الذكاء الاصطناعي على وشك السيطرة على إنسانيتنا.',
    heroLine2: 'شركات بتريليونات الدولارات تتسابق لاستبدال وظائفنا وعلاقاتنا وقوتنا السياسية.',
    heroLine3: 'هذه هي فرصتنا الأخيرة لفعل شيء مختلف.',
